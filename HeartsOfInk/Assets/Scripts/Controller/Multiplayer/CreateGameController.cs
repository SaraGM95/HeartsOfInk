...
public class CreateGameController : MonoBehaviour
{
    ...
    private WebServiceCallerReusable<LogExceptionDto, bool> errorSender = new WebServiceCallerReusable<LogExceptionDto, bool>(ApiConfig.LoggingServerUrl);
    [SerializeField]
    ...
    public async void CreateGame()
    {
        ...
        {
            LogManager.SendException(errorSender, ex, "Method: CreateGame", SceneManager.GetActiveScene().name);
        }
    }
